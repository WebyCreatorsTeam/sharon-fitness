...
const HeroSection = ({
  ...
  return (
    <div
      className={`relative  flex h-fit flex-col items-center gap-10  overflow-x-clip max-lg:w-full md:px-6 md:py-20 lg:items-start lg:px-48 2xl:max-w-screen-desktop 2xl:items-center 2xl:place-self-center`}
    >
